...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/coreators/voter/voter/poll
   */
  queryPollAll = (
    query?: {
    ...
    this.request<VoterQueryAllPollResponse, RpcStatus>({
      path: `/coreators/voter/voter/poll`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/coreators/voter/voter/vote
   */
  queryVoteAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<VoterQueryAllVoteResponse, RpcStatus>({
      path: `/coreators/voter/voter/vote`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
